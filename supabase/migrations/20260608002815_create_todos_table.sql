...
CREATE POLICY "allow_anon_insert" ON "public"."todos" FOR INSERT TO "anon" WITH CHECK (true);



CREATE POLICY "allow_anon_select" ON "public"."todos" FOR SELECT TO "anon" USING (true);
