...
export default function InstrumentDetailError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error(error.message, 'admin/instrumentos/[id]/error-boundary', error)
  }, [error])
    ...
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="bg-white rounded-xl shadow-sm border p-8 max-w-md text-center">
        ...
        <p className="text-gray-600 text-sm mb-4">
          No se pudo cargar la gestión de este instrumento. Verifica que el instrumento exista y que tengas permisos.
        </p>
